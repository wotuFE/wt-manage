...
<template>
  <div class="details">
    ...
    <div class="topInfo">
      ...
      <!-- 姓名 -->
      <div class="name">
        <span v-text="`${manDetail.realName}`"></span><span :style="{color: manDetail.sex === 1 ? 'rgb(50, 154, 228)' : 'rgb(212, 79, 196)', fontWeight: 'bold', marginLeft: '4px'}" v-text="`${manDetail.sex === 1 ? ' ♂' : '♀'}`"></span>
      </div>
    </div>
    <!-- 主要信息 -->
    <div class="mainInfo">
